...
{
    internal sealed class TourOfHeroesProblemDetailsFactory : ProblemDetailsFactory
    {
        private readonly ApiBehaviorOptions _options;

        public TourOfHeroesProblemDetailsFactory(IOptions<ApiBehaviorOptions> options)
        {
